...
6. Enter *Run TechEd2020-SensorManager* as name for your new run configuration.
<br>![](images/01_02_0060.png)

7. Now a new configuration *Run TechEd2020-SensorManager* should appear in the left. Click on the green icon *Run Module*.
